<script lang="ts">
	...
	const conferences: Conference[] = [
		new Conference('west', 'https://via.placeholder.com/300x300', westTeams),
		new Conference('east', 'https://via.placeholder.com/300x300', eastTeams)
	];
</script>
